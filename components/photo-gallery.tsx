...
const photos = [
  {
    ...
    alt: "Nigerian traditional architecture",
    caption: "Ancient Nigerian architecture - so fascinating!",
    rotation: "rotate-3",
  ...
  },
  {
    ...
    caption: "Magical Nigerian sunset 🌅",
    rotation: "-rotate-2",
  ...
  },
  {
    ...
    caption: "Beautiful Nigerian culture and fashion",
    rotation: "rotate-1",
